 ...
 */
final class Version20230818230657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alumno (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(32) NOT NULL, apellido_paterno VARCHAR(16) NOT NULL, apellido_materno VARCHAR(16) NOT NULL, dni VARCHAR(8) NOT NULL)');
